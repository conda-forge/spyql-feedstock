...
Once the `conda-forge` channel has been enabled, `spyql` can be installed with:

```
conda install spyql
```

It is possible to list all of the versions of `spyql` available on your platform with:
